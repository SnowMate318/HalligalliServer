...
GameMessage::GameMessage(GameStatus message, std::vector<ICard*> frontcard, int next_turn)
{
	this->message = message;
	this->frontcard = frontcard;
...
GameMessage::GameMessage(GameStatus message, std::vector<ICard*> frontcard, int next_turn, int target_player)
{
	this->message = message;
	this->frontcard = frontcard;
	this->next_turn = next_turn;
